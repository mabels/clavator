...
echo "tag"
docker tag clavator-os-image-odroid_xu3-arm-$VERSION fastandfearless/clavator:clavator-os-image-odroid_xu3-arm-$VERSION
echo "push"
[  -n "$DOCKER_AUTH" ] && \
  docker push fastandfearless/clavator:clavator-os-image-odroid_xu3-arm-$VERSION
